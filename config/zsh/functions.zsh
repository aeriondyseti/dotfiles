# Functions - Generated from aeriondyseti/dotfiles
...
# Great for pulling files from host to an ssh.
serve() {
    if [[ "$1" == "-h" || "$1" == "--help" ]]; then
...
# Fuzzy search for listener of a port.
fkillport() {
